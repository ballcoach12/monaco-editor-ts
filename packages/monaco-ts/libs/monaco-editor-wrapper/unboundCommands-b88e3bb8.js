import { aH as i, aI as u, iF as d, gN as c, aG as r, cq as f } from "./verifyPrepare-e26a1ce7.js";
function p(a) {
  const o = [], s = /* @__PURE__ */ new Map(), e = (t, m) => {
    if (!s.has(t) && (s.set(t, !0), !(t[0] === "_" || t.indexOf("vscode.") === 0) && a.get(t) !== !0)) {
      if (!m) {
        const n = r.getCommand(t);
        if (n && typeof n.description == "object" && f(n.description.args))
          return;
      }
      o.push(t);
    }
  ...
  for (const t of c.getEditorActions())
    e(t.id, !0);
